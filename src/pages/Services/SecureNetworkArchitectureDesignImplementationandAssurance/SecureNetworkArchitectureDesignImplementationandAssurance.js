...
const SecureNetworkArchitectureDesignImplementationandAssurance = () => {
    return (
        <div>
            <ServiceTitle title="Secure Network Architecture Design, Implementation and Assurance🖥 🖨" description="API PenTesting is focused on exposing security vulnerabilities on the APIs your business exposes" />

            <div className="container wrapper">
                <div className="mt-5 row">
                    <div className="col-lg-6 col-md-12 col-sm-12 col-lg-0 mb-4">
                        <div className="service_banner_title">
                            <h2 data-aos="fade-down" data-aos-delay="100">About Secure Network Architecture, Design, Implementation and Assurance</h2>
                            <p data-aos="fade-down" data-aos-delay="200">API PenTesting is focused on exposing security vulnerabilities on the APIs your business exposes to its users and vendors. Beetles have an established methodology where our pentesters construct user API calls, using the same documentation you provide your users and avail them to identify security issues. API security is crucial to organizational security as they have a similar impact to web applications but requires a different approach and skillset to test thoroughly.</p>
...
export default SecureNetworkArchitectureDesignImplementationandAssurance;
