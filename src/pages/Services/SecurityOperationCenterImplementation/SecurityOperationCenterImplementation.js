...
const SecurityOperationCenterImplementation = () => {
    return (
        <div>
            <ServiceTitle title="Security Operation Center Implementation
🖥 🖨" description="API PenTesting is focused on exposing security vulnerabilities on the APIs your business exposes" />
...
export default SecurityOperationCenterImplementation;
