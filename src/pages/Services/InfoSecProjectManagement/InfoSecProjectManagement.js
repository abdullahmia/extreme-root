...
const InfoSecProjectManagement = () => {
    return (
        <div>
            <ServiceTitle title="InfosecConsultancy 🖥 🖨" description="Capture the Flag requires a playing field of some sort. In both indoor and outdoor versions." />
...
export default InfoSecProjectManagement;
