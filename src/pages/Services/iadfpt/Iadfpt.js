...
const Iadfpt = () => {
    return (
        <div>
            <ServiceTitle title="IT Audit, Digital Forensics and Penetration Testing
" description="IT Audit, Digital Forensics and Penetration Testing
 a playing field of some sort. In both indoor and outdoor versions." />
