...
const Ctf = () => {
    return (
        <div>
            <ServiceTitle title="Capture The Flag (CTF)" description="Capture the Flag requires a playing field of some sort. In both indoor and outdoor versions." />
                ...
                <div className="mt-5 row">
                    <div className="col-lg-6 col-md-12 col-sm-12 col-lg-0 mb-4">
                        <div className="service_banner_title">
                            ...
                            <p data-aos="fade-down" data-aos-delay="200">CTF (Capture The Flag) is a kind of information security competition that challenges contestants to solve a variety of tasks ranging from a scavenger hunt on Wikipedia to basic programming exercises to hacking your way into a server to steal data. In these challenges, the contestant is usually asked to find a specific piece of text that may be hidden on the server or behind a webpage. This goal is called the flag, hence the name!    </p>
