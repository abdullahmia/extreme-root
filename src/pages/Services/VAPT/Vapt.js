...
const Vapt = () => {
    return (
        <div>
            <ServiceTitle title="Internal/External Vulnerability Assessment and Penetration Testing (VAPT)📑" description="Capture the Flag requires a playing field of some sort. In both indoor and outdoor versions." />
